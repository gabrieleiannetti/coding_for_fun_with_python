...
def drawCurrentTime():
    ...
    drawCursor(  hourColor, 15, hourCursorLength,   hour, 12)
    drawCursor(minuteColor,  8, minuteCursorLength, minute, 60)
    drawCursor(secondColor,  3, secondCursorLength, second, 60)
